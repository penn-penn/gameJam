...
// configuration step. It creates a namespace called `gameJam`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        gameJam::cmake::project_name,
        gameJam::cmake::project_version));// version string, acquired
